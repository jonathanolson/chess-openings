...
# read FENs newline-separated from stdin and output WDL and DTM results as JSON
def main():
    if len(sys.argv) < 2:
    ...
    with chess.gaviota.open_tablebase(tablebase_dir) as tablebase:
        ...
        for line in sys.stdin:
            ...
            try:
                ...
                result["dtm"] = tablebase.probe_dtm(board)
            except chess.gaviota.MissingTableError as e:
